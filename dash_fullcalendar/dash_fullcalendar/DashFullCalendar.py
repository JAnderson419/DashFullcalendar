...
class DashFullCalendar(Component):
    """A DashFullCalendar component.
...
- value (string; optional): The value displayed in the input."""
    ...
    def __init__(self, id=Component.UNDEFINED, label=Component.REQUIRED, value=Component.UNDEFINED, **kwargs):
        ...
        self._type = 'DashFullCalendar'
        self._namespace = 'dash_fullcalendar'
        ...
        super(DashFullCalendar, self).__init__(**args)
